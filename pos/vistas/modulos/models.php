      ...
      <div class="box-body">
       ...
       <table class="table table-bordered table-striped dt-responsive tablas" width="100%">
        ...
        <?php
          ...
          $models = ControladorModels::ctrMostrarModels($item, $valor);
            ...
            echo ' <tr>
                    ...
                    <td>
                      ...
                      <div class="btn-group">
                        ...
                        <button class="btn btn-warning btnEditarModel" idModel="'.$value["id"].'" data-toggle="modal" data-target="#modalEditarModel"><i class="fa fa-pencil"></i></button>';

                        if($_SESSION["perfil"] == "Administrador"){

                          echo '<button class="btn btn-danger btnEliminarModel" idModel="'.$value["id"].'"><i class="fa fa-times"></i></button>';
    ...
    <div class="modal-content">
      ...
      <form role="form" method="post">
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control input-lg" name="nuevaModel" placeholder="Ingresar modelo" required>
        ...
        <?php
          ...
          $crearModel = new ControladorModels();
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <?php
          ...
          $editarModel = new ControladorModels();
...
<?php
  ...
  $borrarModel = new ControladorModels();
  $borrarModel -> ctrBorrarModel();
