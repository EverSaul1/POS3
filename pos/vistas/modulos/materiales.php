            ...
            echo ' <tr>
                    ...
                    <td>
                      ...
                      <div class="btn-group">
                        ...
                        <button class="btn btn-warning btnEditarMaterial" idMaterial="'.$value["id"].'" data-toggle="modal" data-target="#modalEditarMaterial"><i class="fa fa-pencil"></i></button>';

                        if($_SESSION["perfil"] == "Administrador"){

                          echo '<button class="btn btn-danger btnEliminarMaterial" idMaterial="'.$value["id"].'"><i class="fa fa-times"></i></button>';
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control input-lg" name="nuevaMaterial" placeholder="Ingresar material" required>
